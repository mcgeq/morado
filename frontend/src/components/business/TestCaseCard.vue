    ...
    <div class="card-body">
      ...
      <div class="flex items-start justify-between">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-10">
            <li><a @click="$emit('edit', testCase)">Edit</a></li>
            <li><a @click="$emit('duplicate', testCase)">Duplicate</a></li>
            <li><a @click="$emit('execute', testCase)">Execute</a></li>
            <li><a @click="$emit('viewHistory', testCase)">View History</a></li>
            <li><a @click="$emit('view', testCase)">View Details</a></li>
            <li class="divider"></li>
            <li><a @click="$emit('delete', testCase)" class="text-error">Delete</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="mt-4 grid grid-cols-2 gap-3">
        ...
        <div class="flex items-center gap-2 text-sm">
          ...
          <span class="text-xs text-base-content/70">
            {{ testCase.scriptCount || 0 }} Scripts
          </span>
        </div>
        ...
        <div class="flex items-center gap-2 text-sm">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-base-content/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 6v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
          </svg>
          <span class="text-xs text-base-content/70">
      ...
      <div v-if="hasTestData" class="mt-3">
        ...
        <div class="flex flex-wrap gap-1">
          <span
            v-for="(_, key) in previewTestData"
            :key="key"
      ...
      <div v-if="testCase.lastExecutionAt" class="mt-3">
        <div class="flex items-center justify-between text-xs">
          ...
          <div class="flex items-center gap-2">
            <span v-if="testCase.lastExecutionStatus" class="badge badge-xs" :class="getExecutionStatusBadge(testCase.lastExecutionStatus)">
