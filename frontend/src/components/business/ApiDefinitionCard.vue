    ...
    <div class="card-body">
      ...
      <div class="flex items-start justify-between">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-10">
            <li><a @click="$emit('edit', apiDefinition)">Edit</a></li>
            <li><a @click="$emit('duplicate', apiDefinition)">Duplicate</a></li>
            <li><a @click="$emit('test', apiDefinition)">Test API</a></li>
            <li><a @click="$emit('view', apiDefinition)">View Details</a></li>
            <li class="divider"></li>
            <li><a @click="$emit('delete', apiDefinition)" class="text-error">Delete</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="mt-4">
        ...
        <div class="flex items-center gap-2">
          <code class="text-xs bg-base-200 px-3 py-2 rounded flex-1 font-mono">
            {{ fullUrl }}
          </code>
        </div>
      </div>
      ...
      <div class="mt-3 grid grid-cols-2 gap-2">
        ...
        <div class="flex items-center gap-2 text-sm">
          ...
          <span class="text-xs text-base-content/70">
            Timeout: {{ apiDefinition.timeout }}s
          </span>
        </div>
      </div>
      ...
      <!-- Tags -->
      <div v-if="apiDefinition.tags && apiDefinition.tags.length > 0" class="mt-3 flex flex-wrap gap-1">
