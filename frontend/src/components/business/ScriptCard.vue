    ...
    <div class="card-body">
      ...
      <div class="flex items-start justify-between">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-10">
            <li><a @click="$emit('edit', script)">Edit</a></li>
            <li><a @click="$emit('duplicate', script)">Duplicate</a></li>
            <li><a @click="$emit('execute', script)">Execute</a></li>
            <li><a @click="$emit('debug', script)">Debug</a></li>
            <li><a @click="$emit('view', script)">View Details</a></li>
            <li class="divider"></li>
            <li><a @click="$emit('delete', script)" class="text-error">Delete</a></li>
          </ul>
        </div>
      </div>
      ...
      <div class="mt-4 grid grid-cols-2 gap-3">
        ...
        <div v-if="script.timeoutOverride" class="flex items-center gap-2 text-sm">
          ...
          <span class="text-xs text-base-content/70">
            Timeout: {{ script.timeoutOverride }}s
          </span>
        </div>
      </div>
