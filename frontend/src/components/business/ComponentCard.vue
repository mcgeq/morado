      ...
      <div class="flex items-start justify-between">
        <div class="flex-1">
          <h3 class="card-title text-lg">
            ...
            <span class="badge badge-sm" :class="typeBadgeClass">{{ component.componentType }}</span>
            <span class="badge badge-sm" :class="modeBadgeClass">{{ component.executionMode }}</span>
          </h3>
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-10">
            <li><a @click="$emit('edit', component)">Edit</a></li>
            <li><a @click="$emit('duplicate', component)">Duplicate</a></li>
            <li><a @click="$emit('execute', component)">Execute</a></li>
            <li><a @click="$emit('viewHierarchy', component)">View Hierarchy</a></li>
            <li><a @click="$emit('view', component)">View Details</a></li>
            <li class="divider"></li>
            <li><a @click="$emit('delete', component)" class="text-error">Delete</a></li>
          </ul>
        </div>
      </div>
...
const hasSharedVariables = computed(() => {
  return props.component.sharedVariables && Object.keys(props.component.sharedVariables).length > 0;
});
