<template>
  <div class="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
    <div class="card-body">
      ...
      <div class="flex items-start justify-between">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-10">
            <li><a @click="$emit('edit', header)">Edit</a></li>
            <li><a @click="$emit('duplicate', header)">Duplicate</a></li>
            <li><a @click="$emit('view', header)">View Details</a></li>
            <li class="divider"></li>
            <li><a @click="$emit('delete', header)" class="text-error">Delete</a></li>
          </ul>
        </div>
      </div>
      ...
      <!-- Headers Preview -->
      <div class="mt-4">
        <div class="text-xs font-semibold text-base-content/60 mb-2">Headers ({{ headerCount }})</div>
        <div class="space-y-1">
          <div v-for="(value, key) in previewHeaders" :key="key" class="flex items-center gap-2 text-sm">
