          ...
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <div class="flex gap-2 mt-1">
                <span class="badge badge-sm" :class="getTypeBadgeClass(rootComponent.componentType)">
                  {{ rootComponent.componentType }}
                </span>
                <span class="badge badge-sm" :class="getModeBadgeClass(rootComponent.executionMode)">
          ...
          <div class="card-body p-3">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                ...
                <span class="text-sm font-medium">{{ script.script?.name || `Script #${script.scriptId}` }}</span>
                <span v-if="script.script" class="badge badge-xs" :class="getScriptTypeBadgeClass(script.script.scriptType)">
                  {{ script.script.scriptType }}
                </span>
              </div>
              <div v-if="script.parameterOverrides && Object.keys(script.parameterOverrides).length > 0" class="tooltip" data-tip="Has parameter overrides">
...
import type { TestComponent, ComponentScript } from '@/api/component';
