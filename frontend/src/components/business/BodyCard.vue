      ...
      <div class="flex items-start justify-between">
        ...
        <div class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52 z-10">
            <li><a @click="$emit('edit', body)">Edit</a></li>
            <li><a @click="$emit('duplicate', body)">Duplicate</a></li>
            <li><a @click="$emit('view', body)">View Details</a></li>
            <li><a @click="$emit('validate', body)">Validate Schema</a></li>
            <li class="divider"></li>
            <li><a @click="$emit('delete', body)" class="text-error">Delete</a></li>
          </ul>
        </div>
      </div>
