...
class ConfigurationManager:
    ...
    def _load_from_toml(file_path: Path) -> LoggerConfig:
        ...
        try:
            ...
            raise ValueError(f"Malformed TOML file: {e}") from e
        except Exception as e:
            raise ValueError(f"Error loading TOML configuration: {e}") from e
    ...
    def _load_from_yaml(file_path: Path) -> LoggerConfig:
        ...
        try:
            ...
            raise ValueError(f"Malformed YAML file: {e}") from e
        except Exception as e:
            raise ValueError(f"Error loading YAML configuration: {e}") from e
